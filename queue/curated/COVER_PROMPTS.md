...
Legend: ✅ = cover.png placed at `assets/curated/<id>/cover.png`. ⏭️ = Monday slot, already consumed — skip.

| Post ID (slot) | Pillar | Status | Cover-image prompt |
|---|---|---|---|
| `20260803_14` (Wealth) | 3 Fiverr gigs paying $100/hr with AI | ⏭️ skip (Monday, consumed) | — |
...
| `20260810_05` (Tech) | AI model launches worth switching to | ⏭️ skip (Monday, consumed) | — |
